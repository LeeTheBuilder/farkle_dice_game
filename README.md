...
Choose either 2-6 player hot-seat mode or a local AI opponent on the setup screen. The default target is 4,000 points, with quick and long match presets available.
...
- Six standard dice.
- Local hot-seat supports 2-6 human players, with automatic player colors by seat order.
- Play AI mode remains a one-human-vs-one-AI match.
